...
public class GoBoomGame {
            ...
            if(checkWin) {
                ...
                if(input.equals("d")) {
                    if(centerDeck.size() == 0) {
                        ...
                        //If none of the players play any card in that round
    ...
    private boolean isGameOver() {
        // Check if any player has reached the maximum score or if the deck is empty
        // ...
        for(Player player: players) {
    ...
    private void displayResults() {
        ...
        for(Player player2: players) {
            System.out.println("Player" + (players.indexOf(player2) + 1) + ": " + player2.getScore());
        }
        ...
        for(Player player: players) {
            ...
            if(player.getScore() > largestScore) {
                ...
                largestIndex = players.indexOf(player);
            }
        }
        System.out.println("********************************************************************");
        System.out.println("Player" + (smallestIndex + 1) + " wins the game!");
        // System.out.println("Player" + (largestIndex + 1) + " loses the game!");
    }
